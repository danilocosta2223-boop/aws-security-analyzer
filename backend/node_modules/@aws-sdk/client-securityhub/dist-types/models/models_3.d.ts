...
import type { AllowedOperators, AssociationStatus, AssociationType, AutoEnableStandards, ConfigurationPolicyAssociationStatus, ConnectorProviderName, ConnectorStatus, ControlFindingGenerator, ControlStatus, CspmConnectorProviderName, CspmConnectorStatus, CspmEnablementStatus, DiscoveryType, EnablementStatus, FreeTrialStatusValue, GroupByField, RecordState, RegionAvailabilityStatus, ResourceCategory, ResourceGroupByField, ResourceSubCategory, RuleStatusV2, SecurityControlProperty, SecurityControlsProvider, SecurityHubFeature, SeverityRating, SortOrder, TargetType } from "./enums";
import type { AccountFreeTrialStatus, AdminAccount, AggregatorV2, AIDetails, AssociationFilters, AutomationRulesActionV2, AutomationRulesMetadata, AutomationRulesMetadataV2, NoteUpdate } from "./models_0";
import type { AwsSecurityFindingFilters, AzureUpdateConfiguration, ConfigurationOptions, ConfigurationPolicyAssociationSummary, ConfigurationPolicySummary, ConnectorSummary, CspmConnectorSummary, CspmProviderUpdateConfiguration, FindingAggregator, FindingScopes, FindingsTrendsStringFilter, Invitation, Member, OcsfBooleanFilter, OcsfDateFilter, OcsfIpFilter, OcsfMapFilter, OcsfNumberFilter, OcsfStringFilter, OrganizationConfiguration, ParameterConfiguration, Policy, ResourceFindingsSummary, ResourceScopes, ResourcesDateFilter, ResourcesMapFilter, ResourcesNumberFilter, ResourcesStringFilter, ResourcesTrendsStringFilter, Result, SortCriterion, Target } from "./models_2";
/**
 ...
 * @public
 */
export type ProviderUpdateConfiguration = ProviderUpdateConfiguration.AzureMember | ProviderUpdateConfiguration.JiraCloudMember | ProviderUpdateConfiguration.ServiceNowMember | ProviderUpdateConfiguration.$UnknownMember;
/**
 * @public
 */
