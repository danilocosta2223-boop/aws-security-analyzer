...
declare const ListFreeTrialStatusesV2Command_base: {
    new (input: ListFreeTrialStatusesV2CommandInput): import("@smithy/core/client").CommandImpl<ListFreeTrialStatusesV2CommandInput, ListFreeTrialStatusesV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFreeTrialStatusesV2CommandInput]): import("@smithy/core/client").CommandImpl<ListFreeTrialStatusesV2CommandInput, ListFreeTrialStatusesV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListFreeTrialStatusesV2Command extends ListFreeTrialStatusesV2Command_base {
