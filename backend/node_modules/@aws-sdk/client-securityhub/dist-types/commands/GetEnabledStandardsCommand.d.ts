...
declare const GetEnabledStandardsCommand_base: {
    new (input: GetEnabledStandardsCommandInput): import("@smithy/core/client").CommandImpl<GetEnabledStandardsCommandInput, GetEnabledStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetEnabledStandardsCommandInput]): import("@smithy/core/client").CommandImpl<GetEnabledStandardsCommandInput, GetEnabledStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
