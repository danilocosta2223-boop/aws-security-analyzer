...
declare const GetFindingHistoryCommand_base: {
    new (input: GetFindingHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetFindingHistoryCommandInput, GetFindingHistoryCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFindingHistoryCommandInput): import("@smithy/core/client").CommandImpl<GetFindingHistoryCommandInput, GetFindingHistoryCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
