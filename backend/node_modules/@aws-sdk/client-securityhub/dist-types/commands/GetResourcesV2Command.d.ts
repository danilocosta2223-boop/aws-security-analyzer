...
declare const GetResourcesV2Command_base: {
    new (input: GetResourcesV2CommandInput): import("@smithy/core/client").CommandImpl<GetResourcesV2CommandInput, GetResourcesV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetResourcesV2CommandInput]): import("@smithy/core/client").CommandImpl<GetResourcesV2CommandInput, GetResourcesV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
