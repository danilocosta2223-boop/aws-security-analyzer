...
declare const UpdateConnectorCommand_base: {
    new (input: UpdateConnectorCommandInput): import("@smithy/core/client").CommandImpl<UpdateConnectorCommandInput, UpdateConnectorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateConnectorCommandInput): import("@smithy/core/client").CommandImpl<UpdateConnectorCommandInput, UpdateConnectorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
