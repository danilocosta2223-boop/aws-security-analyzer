...
declare const DescribeSecurityHubV2Command_base: {
    new (input: DescribeSecurityHubV2CommandInput): import("@smithy/core/client").CommandImpl<DescribeSecurityHubV2CommandInput, DescribeSecurityHubV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSecurityHubV2CommandInput]): import("@smithy/core/client").CommandImpl<DescribeSecurityHubV2CommandInput, DescribeSecurityHubV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
