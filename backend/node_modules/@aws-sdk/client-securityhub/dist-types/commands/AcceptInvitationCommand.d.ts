...
declare const AcceptInvitationCommand_base: {
    new (input: AcceptInvitationCommandInput): import("@smithy/core/client").CommandImpl<AcceptInvitationCommandInput, AcceptInvitationCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptInvitationCommandInput): import("@smithy/core/client").CommandImpl<AcceptInvitationCommandInput, AcceptInvitationCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
