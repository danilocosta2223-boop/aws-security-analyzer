...
declare const GetAggregatorV2Command_base: {
    new (input: GetAggregatorV2CommandInput): import("@smithy/core/client").CommandImpl<GetAggregatorV2CommandInput, GetAggregatorV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAggregatorV2CommandInput): import("@smithy/core/client").CommandImpl<GetAggregatorV2CommandInput, GetAggregatorV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
