...
declare const DescribeActionTargetsCommand_base: {
    new (input: DescribeActionTargetsCommandInput): import("@smithy/core/client").CommandImpl<DescribeActionTargetsCommandInput, DescribeActionTargetsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeActionTargetsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeActionTargetsCommandInput, DescribeActionTargetsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
