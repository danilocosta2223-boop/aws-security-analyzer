...
declare const GetInvitationsCountCommand_base: {
    new (input: GetInvitationsCountCommandInput): import("@smithy/core/client").CommandImpl<GetInvitationsCountCommandInput, GetInvitationsCountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetInvitationsCountCommandInput]): import("@smithy/core/client").CommandImpl<GetInvitationsCountCommandInput, GetInvitationsCountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
