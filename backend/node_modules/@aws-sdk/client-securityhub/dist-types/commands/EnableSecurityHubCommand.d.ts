...
declare const EnableSecurityHubCommand_base: {
    new (input: EnableSecurityHubCommandInput): import("@smithy/core/client").CommandImpl<EnableSecurityHubCommandInput, EnableSecurityHubCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableSecurityHubCommandInput]): import("@smithy/core/client").CommandImpl<EnableSecurityHubCommandInput, EnableSecurityHubCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
