...
declare const GetConfigurationPolicyCommand_base: {
    new (input: GetConfigurationPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetConfigurationPolicyCommandInput, GetConfigurationPolicyCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConfigurationPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetConfigurationPolicyCommandInput, GetConfigurationPolicyCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
