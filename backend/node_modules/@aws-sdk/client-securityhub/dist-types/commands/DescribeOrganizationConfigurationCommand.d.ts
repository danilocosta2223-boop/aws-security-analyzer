...
declare const DescribeOrganizationConfigurationCommand_base: {
    new (input: DescribeOrganizationConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DescribeOrganizationConfigurationCommandInput, DescribeOrganizationConfigurationCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeOrganizationConfigurationCommandInput]): import("@smithy/core/client").CommandImpl<DescribeOrganizationConfigurationCommandInput, DescribeOrganizationConfigurationCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
