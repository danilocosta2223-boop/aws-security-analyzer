...
declare const BatchGetAutomationRulesCommand_base: {
    new (input: BatchGetAutomationRulesCommandInput): import("@smithy/core/client").CommandImpl<BatchGetAutomationRulesCommandInput, BatchGetAutomationRulesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetAutomationRulesCommandInput): import("@smithy/core/client").CommandImpl<BatchGetAutomationRulesCommandInput, BatchGetAutomationRulesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
