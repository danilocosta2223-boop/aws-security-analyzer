...
declare const InviteMembersCommand_base: {
    new (input: InviteMembersCommandInput): import("@smithy/core/client").CommandImpl<InviteMembersCommandInput, InviteMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: InviteMembersCommandInput): import("@smithy/core/client").CommandImpl<InviteMembersCommandInput, InviteMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
