...
declare const ListConnectorsV2Command_base: {
    new (input: ListConnectorsV2CommandInput): import("@smithy/core/client").CommandImpl<ListConnectorsV2CommandInput, ListConnectorsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConnectorsV2CommandInput]): import("@smithy/core/client").CommandImpl<ListConnectorsV2CommandInput, ListConnectorsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
