...
declare const DescribeProductsCommand_base: {
    new (input: DescribeProductsCommandInput): import("@smithy/core/client").CommandImpl<DescribeProductsCommandInput, DescribeProductsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeProductsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeProductsCommandInput, DescribeProductsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
