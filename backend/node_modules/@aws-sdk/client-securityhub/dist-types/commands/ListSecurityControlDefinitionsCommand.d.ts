...
declare const ListSecurityControlDefinitionsCommand_base: {
    new (input: ListSecurityControlDefinitionsCommandInput): import("@smithy/core/client").CommandImpl<ListSecurityControlDefinitionsCommandInput, ListSecurityControlDefinitionsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSecurityControlDefinitionsCommandInput]): import("@smithy/core/client").CommandImpl<ListSecurityControlDefinitionsCommandInput, ListSecurityControlDefinitionsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
