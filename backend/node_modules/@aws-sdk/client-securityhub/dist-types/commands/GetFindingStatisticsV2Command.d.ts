...
declare const GetFindingStatisticsV2Command_base: {
    new (input: GetFindingStatisticsV2CommandInput): import("@smithy/core/client").CommandImpl<GetFindingStatisticsV2CommandInput, GetFindingStatisticsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFindingStatisticsV2CommandInput): import("@smithy/core/client").CommandImpl<GetFindingStatisticsV2CommandInput, GetFindingStatisticsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
