...
declare const BatchEnableStandardsCommand_base: {
    new (input: BatchEnableStandardsCommandInput): import("@smithy/core/client").CommandImpl<BatchEnableStandardsCommandInput, BatchEnableStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchEnableStandardsCommandInput): import("@smithy/core/client").CommandImpl<BatchEnableStandardsCommandInput, BatchEnableStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
