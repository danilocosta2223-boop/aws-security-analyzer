...
declare const ListAggregatorsV2Command_base: {
    new (input: ListAggregatorsV2CommandInput): import("@smithy/core/client").CommandImpl<ListAggregatorsV2CommandInput, ListAggregatorsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAggregatorsV2CommandInput]): import("@smithy/core/client").CommandImpl<ListAggregatorsV2CommandInput, ListAggregatorsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
