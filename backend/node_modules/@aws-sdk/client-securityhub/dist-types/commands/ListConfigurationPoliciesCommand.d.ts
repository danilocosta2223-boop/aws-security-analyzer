...
declare const ListConfigurationPoliciesCommand_base: {
    new (input: ListConfigurationPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListConfigurationPoliciesCommandInput, ListConfigurationPoliciesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConfigurationPoliciesCommandInput]): import("@smithy/core/client").CommandImpl<ListConfigurationPoliciesCommandInput, ListConfigurationPoliciesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
