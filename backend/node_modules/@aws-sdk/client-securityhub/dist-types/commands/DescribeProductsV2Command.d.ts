...
declare const DescribeProductsV2Command_base: {
    new (input: DescribeProductsV2CommandInput): import("@smithy/core/client").CommandImpl<DescribeProductsV2CommandInput, DescribeProductsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeProductsV2CommandInput]): import("@smithy/core/client").CommandImpl<DescribeProductsV2CommandInput, DescribeProductsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
