...
declare const BatchGetSecurityControlsCommand_base: {
    new (input: BatchGetSecurityControlsCommandInput): import("@smithy/core/client").CommandImpl<BatchGetSecurityControlsCommandInput, BatchGetSecurityControlsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchGetSecurityControlsCommandInput): import("@smithy/core/client").CommandImpl<BatchGetSecurityControlsCommandInput, BatchGetSecurityControlsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
