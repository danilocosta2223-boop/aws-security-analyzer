...
declare const DeleteInvitationsCommand_base: {
    new (input: DeleteInvitationsCommandInput): import("@smithy/core/client").CommandImpl<DeleteInvitationsCommandInput, DeleteInvitationsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteInvitationsCommandInput): import("@smithy/core/client").CommandImpl<DeleteInvitationsCommandInput, DeleteInvitationsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
