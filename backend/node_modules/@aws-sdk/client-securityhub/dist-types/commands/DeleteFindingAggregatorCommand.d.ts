...
declare const DeleteFindingAggregatorCommand_base: {
    new (input: DeleteFindingAggregatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteFindingAggregatorCommandInput, DeleteFindingAggregatorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFindingAggregatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteFindingAggregatorCommandInput, DeleteFindingAggregatorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
