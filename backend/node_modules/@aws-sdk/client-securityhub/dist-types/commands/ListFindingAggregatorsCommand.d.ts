...
declare const ListFindingAggregatorsCommand_base: {
    new (input: ListFindingAggregatorsCommandInput): import("@smithy/core/client").CommandImpl<ListFindingAggregatorsCommandInput, ListFindingAggregatorsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListFindingAggregatorsCommandInput]): import("@smithy/core/client").CommandImpl<ListFindingAggregatorsCommandInput, ListFindingAggregatorsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
