...
declare const GetMembersCommand_base: {
    new (input: GetMembersCommandInput): import("@smithy/core/client").CommandImpl<GetMembersCommandInput, GetMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMembersCommandInput): import("@smithy/core/client").CommandImpl<GetMembersCommandInput, GetMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
