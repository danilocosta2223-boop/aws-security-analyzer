...
declare const DisassociateMembersCommand_base: {
    new (input: DisassociateMembersCommandInput): import("@smithy/core/client").CommandImpl<DisassociateMembersCommandInput, DisassociateMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateMembersCommandInput): import("@smithy/core/client").CommandImpl<DisassociateMembersCommandInput, DisassociateMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
