...
declare const BatchDeleteAutomationRulesCommand_base: {
    new (input: BatchDeleteAutomationRulesCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteAutomationRulesCommandInput, BatchDeleteAutomationRulesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDeleteAutomationRulesCommandInput): import("@smithy/core/client").CommandImpl<BatchDeleteAutomationRulesCommandInput, BatchDeleteAutomationRulesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
