...
declare const ListAutomationRulesCommand_base: {
    new (input: ListAutomationRulesCommandInput): import("@smithy/core/client").CommandImpl<ListAutomationRulesCommandInput, ListAutomationRulesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAutomationRulesCommandInput]): import("@smithy/core/client").CommandImpl<ListAutomationRulesCommandInput, ListAutomationRulesCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
