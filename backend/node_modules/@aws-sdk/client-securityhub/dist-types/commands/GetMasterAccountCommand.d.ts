...
declare const GetMasterAccountCommand_base: {
    new (input: GetMasterAccountCommandInput): import("@smithy/core/client").CommandImpl<GetMasterAccountCommandInput, GetMasterAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetMasterAccountCommandInput]): import("@smithy/core/client").CommandImpl<GetMasterAccountCommandInput, GetMasterAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
