...
declare const GetResourcesTrendsV2Command_base: {
    new (input: GetResourcesTrendsV2CommandInput): import("@smithy/core/client").CommandImpl<GetResourcesTrendsV2CommandInput, GetResourcesTrendsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourcesTrendsV2CommandInput): import("@smithy/core/client").CommandImpl<GetResourcesTrendsV2CommandInput, GetResourcesTrendsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
