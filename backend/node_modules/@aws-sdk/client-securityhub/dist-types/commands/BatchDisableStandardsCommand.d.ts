...
declare const BatchDisableStandardsCommand_base: {
    new (input: BatchDisableStandardsCommandInput): import("@smithy/core/client").CommandImpl<BatchDisableStandardsCommandInput, BatchDisableStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: BatchDisableStandardsCommandInput): import("@smithy/core/client").CommandImpl<BatchDisableStandardsCommandInput, BatchDisableStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
