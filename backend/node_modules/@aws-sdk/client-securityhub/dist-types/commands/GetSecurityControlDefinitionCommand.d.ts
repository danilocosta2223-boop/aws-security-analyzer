...
declare const GetSecurityControlDefinitionCommand_base: {
    new (input: GetSecurityControlDefinitionCommandInput): import("@smithy/core/client").CommandImpl<GetSecurityControlDefinitionCommandInput, GetSecurityControlDefinitionCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSecurityControlDefinitionCommandInput): import("@smithy/core/client").CommandImpl<GetSecurityControlDefinitionCommandInput, GetSecurityControlDefinitionCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
