...
declare const GetConnectorCommand_base: {
    new (input: GetConnectorCommandInput): import("@smithy/core/client").CommandImpl<GetConnectorCommandInput, GetConnectorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConnectorCommandInput): import("@smithy/core/client").CommandImpl<GetConnectorCommandInput, GetConnectorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
