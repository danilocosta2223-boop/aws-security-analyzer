...
declare const GetResourcesStatisticsV2Command_base: {
    new (input: GetResourcesStatisticsV2CommandInput): import("@smithy/core/client").CommandImpl<GetResourcesStatisticsV2CommandInput, GetResourcesStatisticsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourcesStatisticsV2CommandInput): import("@smithy/core/client").CommandImpl<GetResourcesStatisticsV2CommandInput, GetResourcesStatisticsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
