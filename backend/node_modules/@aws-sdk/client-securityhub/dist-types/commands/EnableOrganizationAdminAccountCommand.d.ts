...
declare const EnableOrganizationAdminAccountCommand_base: {
    new (input: EnableOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<EnableOrganizationAdminAccountCommandInput, EnableOrganizationAdminAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<EnableOrganizationAdminAccountCommandInput, EnableOrganizationAdminAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
