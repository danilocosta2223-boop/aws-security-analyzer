...
declare const DescribeStandardsCommand_base: {
    new (input: DescribeStandardsCommandInput): import("@smithy/core/client").CommandImpl<DescribeStandardsCommandInput, DescribeStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeStandardsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeStandardsCommandInput, DescribeStandardsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
