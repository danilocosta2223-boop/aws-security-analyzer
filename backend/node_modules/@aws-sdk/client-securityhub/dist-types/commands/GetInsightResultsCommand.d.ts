...
declare const GetInsightResultsCommand_base: {
    new (input: GetInsightResultsCommandInput): import("@smithy/core/client").CommandImpl<GetInsightResultsCommandInput, GetInsightResultsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInsightResultsCommandInput): import("@smithy/core/client").CommandImpl<GetInsightResultsCommandInput, GetInsightResultsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
