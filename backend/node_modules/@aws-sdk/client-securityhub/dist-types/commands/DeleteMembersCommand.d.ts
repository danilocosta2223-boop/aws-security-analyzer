...
declare const DeleteMembersCommand_base: {
    new (input: DeleteMembersCommandInput): import("@smithy/core/client").CommandImpl<DeleteMembersCommandInput, DeleteMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMembersCommandInput): import("@smithy/core/client").CommandImpl<DeleteMembersCommandInput, DeleteMembersCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
