...
declare const GetFindingsCommand_base: {
    new (input: GetFindingsCommandInput): import("@smithy/core/client").CommandImpl<GetFindingsCommandInput, GetFindingsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetFindingsCommandInput]): import("@smithy/core/client").CommandImpl<GetFindingsCommandInput, GetFindingsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
