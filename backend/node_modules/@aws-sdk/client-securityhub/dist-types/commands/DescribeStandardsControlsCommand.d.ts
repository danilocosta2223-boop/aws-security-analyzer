...
declare const DescribeStandardsControlsCommand_base: {
    new (input: DescribeStandardsControlsCommandInput): import("@smithy/core/client").CommandImpl<DescribeStandardsControlsCommandInput, DescribeStandardsControlsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeStandardsControlsCommandInput): import("@smithy/core/client").CommandImpl<DescribeStandardsControlsCommandInput, DescribeStandardsControlsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
