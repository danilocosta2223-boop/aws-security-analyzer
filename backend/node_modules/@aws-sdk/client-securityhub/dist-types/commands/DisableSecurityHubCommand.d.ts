...
declare const DisableSecurityHubCommand_base: {
    new (input: DisableSecurityHubCommandInput): import("@smithy/core/client").CommandImpl<DisableSecurityHubCommandInput, DisableSecurityHubCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableSecurityHubCommandInput]): import("@smithy/core/client").CommandImpl<DisableSecurityHubCommandInput, DisableSecurityHubCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
