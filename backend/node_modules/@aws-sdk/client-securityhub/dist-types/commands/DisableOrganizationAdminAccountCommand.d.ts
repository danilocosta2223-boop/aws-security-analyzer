...
declare const DisableOrganizationAdminAccountCommand_base: {
    new (input: DisableOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<DisableOrganizationAdminAccountCommandInput, DisableOrganizationAdminAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableOrganizationAdminAccountCommandInput): import("@smithy/core/client").CommandImpl<DisableOrganizationAdminAccountCommandInput, DisableOrganizationAdminAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
