...
declare const GetAdministratorAccountCommand_base: {
    new (input: GetAdministratorAccountCommandInput): import("@smithy/core/client").CommandImpl<GetAdministratorAccountCommandInput, GetAdministratorAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAdministratorAccountCommandInput]): import("@smithy/core/client").CommandImpl<GetAdministratorAccountCommandInput, GetAdministratorAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
