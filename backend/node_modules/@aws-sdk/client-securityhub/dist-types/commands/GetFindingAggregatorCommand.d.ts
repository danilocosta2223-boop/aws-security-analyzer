...
declare const GetFindingAggregatorCommand_base: {
    new (input: GetFindingAggregatorCommandInput): import("@smithy/core/client").CommandImpl<GetFindingAggregatorCommandInput, GetFindingAggregatorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFindingAggregatorCommandInput): import("@smithy/core/client").CommandImpl<GetFindingAggregatorCommandInput, GetFindingAggregatorCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
