...
declare const ListAutomationRulesV2Command_base: {
    new (input: ListAutomationRulesV2CommandInput): import("@smithy/core/client").CommandImpl<ListAutomationRulesV2CommandInput, ListAutomationRulesV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAutomationRulesV2CommandInput]): import("@smithy/core/client").CommandImpl<ListAutomationRulesV2CommandInput, ListAutomationRulesV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
