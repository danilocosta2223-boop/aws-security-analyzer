...
import type { ListConfigurationPolicyAssociationsRequest, ListConfigurationPolicyAssociationsResponse } from "../models/models_3";
/**
 * @public
 */
...
declare const ListConfigurationPolicyAssociationsCommand_base: {
    new (input: ListConfigurationPolicyAssociationsCommandInput): import("@smithy/core/client").CommandImpl<ListConfigurationPolicyAssociationsCommandInput, ListConfigurationPolicyAssociationsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListConfigurationPolicyAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<ListConfigurationPolicyAssociationsCommandInput, ListConfigurationPolicyAssociationsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
