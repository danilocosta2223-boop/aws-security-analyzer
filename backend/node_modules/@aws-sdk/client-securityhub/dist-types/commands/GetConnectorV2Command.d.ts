...
declare const GetConnectorV2Command_base: {
    new (input: GetConnectorV2CommandInput): import("@smithy/core/client").CommandImpl<GetConnectorV2CommandInput, GetConnectorV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetConnectorV2CommandInput): import("@smithy/core/client").CommandImpl<GetConnectorV2CommandInput, GetConnectorV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
