...
declare const GetFindingsTrendsV2Command_base: {
    new (input: GetFindingsTrendsV2CommandInput): import("@smithy/core/client").CommandImpl<GetFindingsTrendsV2CommandInput, GetFindingsTrendsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFindingsTrendsV2CommandInput): import("@smithy/core/client").CommandImpl<GetFindingsTrendsV2CommandInput, GetFindingsTrendsV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
