...
declare const GetAutomationRuleV2Command_base: {
    new (input: GetAutomationRuleV2CommandInput): import("@smithy/core/client").CommandImpl<GetAutomationRuleV2CommandInput, GetAutomationRuleV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAutomationRuleV2CommandInput): import("@smithy/core/client").CommandImpl<GetAutomationRuleV2CommandInput, GetAutomationRuleV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
