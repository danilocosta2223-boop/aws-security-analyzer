...
declare const DisassociateFromMasterAccountCommand_base: {
    new (input: DisassociateFromMasterAccountCommandInput): import("@smithy/core/client").CommandImpl<DisassociateFromMasterAccountCommandInput, DisassociateFromMasterAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisassociateFromMasterAccountCommandInput]): import("@smithy/core/client").CommandImpl<DisassociateFromMasterAccountCommandInput, DisassociateFromMasterAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
