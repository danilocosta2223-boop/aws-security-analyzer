...
declare const EnableSecurityHubFeatureV2Command_base: {
    new (input: EnableSecurityHubFeatureV2CommandInput): import("@smithy/core/client").CommandImpl<EnableSecurityHubFeatureV2CommandInput, EnableSecurityHubFeatureV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableSecurityHubFeatureV2CommandInput): import("@smithy/core/client").CommandImpl<EnableSecurityHubFeatureV2CommandInput, EnableSecurityHubFeatureV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class EnableSecurityHubFeatureV2Command extends EnableSecurityHubFeatureV2Command_base {
