...
declare const GetRecommendedPolicyV2Command_base: {
    new (input: GetRecommendedPolicyV2CommandInput): import("@smithy/core/client").CommandImpl<GetRecommendedPolicyV2CommandInput, GetRecommendedPolicyV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRecommendedPolicyV2CommandInput): import("@smithy/core/client").CommandImpl<GetRecommendedPolicyV2CommandInput, GetRecommendedPolicyV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
