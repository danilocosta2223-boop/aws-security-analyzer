...
declare const DisassociateFromAdministratorAccountCommand_base: {
    new (input: DisassociateFromAdministratorAccountCommandInput): import("@smithy/core/client").CommandImpl<DisassociateFromAdministratorAccountCommandInput, DisassociateFromAdministratorAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisassociateFromAdministratorAccountCommandInput]): import("@smithy/core/client").CommandImpl<DisassociateFromAdministratorAccountCommandInput, DisassociateFromAdministratorAccountCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
