...
declare const DisableSecurityHubV2Command_base: {
    new (input: DisableSecurityHubV2CommandInput): import("@smithy/core/client").CommandImpl<DisableSecurityHubV2CommandInput, DisableSecurityHubV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableSecurityHubV2CommandInput]): import("@smithy/core/client").CommandImpl<DisableSecurityHubV2CommandInput, DisableSecurityHubV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
