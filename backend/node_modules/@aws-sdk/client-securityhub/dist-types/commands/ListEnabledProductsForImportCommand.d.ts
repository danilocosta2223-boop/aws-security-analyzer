...
declare const ListEnabledProductsForImportCommand_base: {
    new (input: ListEnabledProductsForImportCommandInput): import("@smithy/core/client").CommandImpl<ListEnabledProductsForImportCommandInput, ListEnabledProductsForImportCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEnabledProductsForImportCommandInput]): import("@smithy/core/client").CommandImpl<ListEnabledProductsForImportCommandInput, ListEnabledProductsForImportCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
