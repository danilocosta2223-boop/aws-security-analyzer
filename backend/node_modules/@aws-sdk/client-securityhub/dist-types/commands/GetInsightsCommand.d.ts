...
declare const GetInsightsCommand_base: {
    new (input: GetInsightsCommandInput): import("@smithy/core/client").CommandImpl<GetInsightsCommandInput, GetInsightsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetInsightsCommandInput]): import("@smithy/core/client").CommandImpl<GetInsightsCommandInput, GetInsightsCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
