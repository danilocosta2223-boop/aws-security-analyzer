...
declare const DescribeHubCommand_base: {
    new (input: DescribeHubCommandInput): import("@smithy/core/client").CommandImpl<DescribeHubCommandInput, DescribeHubCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeHubCommandInput]): import("@smithy/core/client").CommandImpl<DescribeHubCommandInput, DescribeHubCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
