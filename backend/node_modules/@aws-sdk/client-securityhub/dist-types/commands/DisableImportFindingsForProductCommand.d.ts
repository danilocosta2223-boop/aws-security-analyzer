...
declare const DisableImportFindingsForProductCommand_base: {
    new (input: DisableImportFindingsForProductCommandInput): import("@smithy/core/client").CommandImpl<DisableImportFindingsForProductCommandInput, DisableImportFindingsForProductCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableImportFindingsForProductCommandInput): import("@smithy/core/client").CommandImpl<DisableImportFindingsForProductCommandInput, DisableImportFindingsForProductCommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
