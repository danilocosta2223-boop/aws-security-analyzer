...
declare const EnableSecurityHubV2Command_base: {
    new (input: EnableSecurityHubV2CommandInput): import("@smithy/core/client").CommandImpl<EnableSecurityHubV2CommandInput, EnableSecurityHubV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableSecurityHubV2CommandInput]): import("@smithy/core/client").CommandImpl<EnableSecurityHubV2CommandInput, EnableSecurityHubV2CommandOutput, import("..").SecurityHubClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
