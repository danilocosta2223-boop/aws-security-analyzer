export declare const FreeTrialType: {
  readonly SECURITY_HUB_V2: "SECURITY_HUB_V2";
  readonly SECURITY_HUB_V2_MULTI_CLOUD_AZURE: "SECURITY_HUB_V2_MULTI_CLOUD_AZURE";
};
export type FreeTrialType = (typeof FreeTrialType)[keyof typeof FreeTrialType];
export declare const FreeTrialStatusValue: {
...
export declare const Partition: {
  ...
  readonly AWS_US_ISO: "aws-us-iso";
  readonly AWS_US_ISO_B: "aws-us-iso-b";
  readonly AZURE_CLOUD: "AzureCloud";
};
export type Partition = (typeof Partition)[keyof typeof Partition];
export declare const CloudProviderName: {
  readonly AWS: "AWS";
...
export declare const StandardsProvider: {
  readonly AWS: "AWS";
  readonly Azure: "Azure";
};
...
export declare const StatusReasonCode: {
  ...
  readonly NO_AVAILABLE_MULTICLOUD_CONNECTOR: "NO_AVAILABLE_MULTICLOUD_CONNECTOR";
};
...
export declare const SecurityControlsProvider: {
  readonly AWS: "AWS";
  readonly Azure: "Azure";
};
export type SecurityControlsProvider =
  (typeof SecurityControlsProvider)[keyof typeof SecurityControlsProvider];
...
export declare const OcsfStringField: {
  ...
  readonly RESOURCES_NAME: "resources.name";
  readonly RESOURCES_OWNER_ACCOUNT_NAME: "resources.owner.account.name";
  readonly RESOURCES_OWNER_ACCOUNT_UID: "resources.owner.account.uid";
  readonly RESOURCES_OWNER_ORG_UID: "resources.owner.org.uid";
  readonly RESOURCES_PROVIDER: "resources.provider";
...
export declare const CspmConnectorStatus: {
  readonly CONNECTED: "CONNECTED";
  readonly DEGRADED: "DEGRADED";
  readonly FAILED_TO_CONNECT: "FAILED_TO_CONNECT";
  readonly UNKNOWN: "UNKNOWN";
...
export declare const CspmEnablementStatus: {
  readonly ENABLED: "ENABLED";
  readonly PENDING_DELETION: "PENDING_DELETION";
  readonly PENDING_ENABLEMENT: "PENDING_ENABLEMENT";
  readonly PENDING_UPDATE: "PENDING_UPDATE";
...
export declare const CspmConnectorProviderName: {
  readonly AZURE: "AZURE";
};
export type CspmConnectorProviderName =
  (typeof CspmConnectorProviderName)[keyof typeof CspmConnectorProviderName];
export declare const HealthIssueCode: {
  readonly AUTHENTICATION_FAILURE: "AUTHENTICATION_FAILURE";
  readonly DISCOVERY_FAILURE: "DISCOVERY_FAILURE";
  readonly NO_HEALTH_DATA: "NO_HEALTH_DATA";
  readonly RECORDING_FAILURE: "RECORDING_FAILURE";
  readonly STREAM_AUTHORIZATION_FAILURE: "STREAM_AUTHORIZATION_FAILURE";
  readonly STREAM_DISCONNECTED: "STREAM_DISCONNECTED";
  readonly STREAM_LIMIT_EXCEEDED: "STREAM_LIMIT_EXCEEDED";
};
...
export declare const FeatureName: {
  readonly NETWORK_SCANNING: "NETWORK_SCANNING";
};
...
export declare const FindingsTrendsStringField: {
  ...
  readonly RESOURCE_CLOUD_PROVIDERS: "resource_cloud_providers";
  readonly RESOURCE_OWNER_IDS: "resource_owner_ids";
  readonly RESOURCE_OWNER_ORGANIZATION_IDS: "resource_owner_organization_ids";
  readonly RESOURCE_REGIONS: "resource_regions";
};
...
export declare const ResourcesNumberField: {
  readonly SELF_HOSTED_AI_AGENT_FRAMEWORK_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedAIAgentFrameworkResourceCount";
  readonly SELF_HOSTED_AI_AGENT_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedAIAgentResourceCount";
  readonly SELF_HOSTED_AI_AGENT_TOOLS_AND_IDENTITY_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedAIAgentToolsAndIdentityResourceCount";
  readonly SELF_HOSTED_AI_DEVELOPMENT_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedAIDevelopmentResourceCount";
  readonly SELF_HOSTED_AI_EXTERNAL_ENDPOINT_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedAIExternalEndpointResourceCount";
  readonly SELF_HOSTED_AI_MODEL_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedAIModelResourceCount";
  readonly SELF_HOSTED_AI_MODEL_SERVING_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedAIModelServingResourceCount";
  readonly SELF_HOSTED_TOTAL_AI_RESOURCE_COUNT: "ResourceInfo.AIDetails.SelfHostedTotalAIResourceCount";
...
export declare const ResourcesStringField: {
  ...
  readonly ACCOUNT_NAME: "AccountName";
  readonly CANONICAL_ID: "ResourceInfo.AIDetails.CanonicalId";
  readonly DISCOVERY_TYPE: "DiscoveryType";
  readonly FINDING_TYPE: "FindingsSummary.FindingType";
  readonly HOST_RESOURCE_GUID: "ResourceInfo.AIDetails.HostResourceGuid";
  readonly HOST_RESOURCE_TYPE: "ResourceInfo.AIDetails.HostResourceType";
  readonly PRODUCT_NAME: "FindingsSummary.ProductName";
  readonly REGION: "Region";
  readonly RESOURCE_CATEGORY: "ResourceCategory";
  readonly RESOURCE_CLOUD_PARTITION: "ResourceCloudPartition";
  readonly RESOURCE_GUID: "ResourceGuid";
  readonly RESOURCE_ID: "ResourceId";
  readonly RESOURCE_NAME: "ResourceName";
  readonly RESOURCE_OWNER_ACCOUNT_ID: "ResourceOwnerAccountId";
  readonly RESOURCE_OWNER_ORG_ID: "ResourceOwnerOrgId";
  readonly RESOURCE_PROVIDER: "ResourceProvider";
  readonly RESOURCE_REGION: "ResourceRegion";
  readonly RESOURCE_SUB_CATEGORY: "ResourceSubCategory";
...
export declare const ResourcesTrendsStringField: {
  ...
  readonly RESOURCE_CLOUD_PROVIDER: "resource_cloud_provider";
  readonly RESOURCE_OWNER_ID: "resource_owner_id";
  readonly RESOURCE_OWNER_ORGANIZATION_ID: "resource_owner_organization_id";
  readonly RESOURCE_REGION: "resource_region";
...
export declare const ResourceSubCategory: {
  readonly AGENT: "Agent";
  readonly AGENT_FRAMEWORK: "AgentFramework";
  readonly AGENT_TOOLS_AND_IDENTITY: "AgentToolsAndIdentity";
  readonly DEVELOPMENT: "Development";
  readonly EXTERNAL_ENDPOINT: "ExternalEndpoint";
  readonly KNOWLEDGE_AND_DATA: "KnowledgeAndData";
  readonly MODEL: "Model";
  readonly MODEL_SERVING: "ModelServing";
  readonly ORCHESTRATION_AND_PIPELINE: "OrchestrationAndPipeline";
  readonly OTHER: "Other";
  readonly SAFETY_AND_GUARDRAIL: "SafetyAndGuardrail";
};
